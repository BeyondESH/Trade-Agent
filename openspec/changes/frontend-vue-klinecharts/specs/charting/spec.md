...
系统 SHALL 用 klinecharts 渲染 K 线,并叠加指标线、S/R 水平线,以及趋势线与箱体 overlay。
...
系统 SHALL 提供纯函数将 API 数据转换为 klinecharts 所需格式(K 线序列、价格线、趋势线段、箱体矩形),时间戳单位与 API 的毫秒 `open_time` 对齐。
