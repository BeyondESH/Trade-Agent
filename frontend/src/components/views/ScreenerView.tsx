...
export const ScreenerView: React.FC<Props> = ({ symbols, onOpenChartWithTicker, theme }) => {
  ...
  const handleExportCsv = () => {
    ...
    const header = ["Ticker", "Asset", "Category", "Price", "Change %", "24h High", "24h Low"];
  ...
  return (
    ...
    >
      ...
      {/* Filter Bar Controls */}
      <div
        className={`p-3 rounded-xl border mb-4 flex items-center justify-between flex-wrap gap-3 ${
      ...
      >
        <div className="overflow-x-auto flex-1">
          <table className="w-full text-left font-mono text-xs">
            <thead>
              <tr
                className={`border-b text-gray-500 uppercase text-[10px] font-sans ${isDark ? "border-[#2a2e39] bg-[#131722]" : "border-[#e0e3eb] bg-gray-50"}`}
              >
              ...
              {filteredItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td
                      className={`py-2.5 px-3 font-bold ${isUp ? "text-[#089981]" : "text-[#f23645]"}`}
                    >
