      ...
      <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
        <div>
          <h1 className="text-xl font-bold text-white flex items-center gap-2">
            ...
            <span>BlockBeats News & Economic Calendar</span>
          </h1>
          <p className="text-xs text-gray-400 mt-0.5">
            Real-time crypto newsflash (BlockBeats), central bank decisions, and earnings releases.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          {error && (
            <div className="flex items-center gap-2 text-xs text-[#f23645]">
              ...
              <span>News feed unavailable: {error}</span>
            </div>
          )}
