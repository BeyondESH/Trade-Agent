...
export const CommandPaletteModal: React.FC<Props> = ({
  ...
  const actions = [
    ...
    { id: 'view-pine', label: 'Open Pine Script Studio', type: 'view' as const, view: 'pine' as DesktopViewMode, icon: <Code className="w-4 h-4 text-[#e91e63]" /> },
    { id: 'view-brokers', label: 'Open Broker Accounts', type: 'view' as const, view: 'brokers' as DesktopViewMode, icon: <Briefcase className="w-4 h-4 text-[#089981]" /> },
