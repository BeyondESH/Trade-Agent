...
var _5 = (e, t, n) => t in e ? v5(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var M1 = (e, t, n) => (_5(e, typeof t != "symbol" ? t + "" : t, n), n);
import { utils as F, init as L5, FormatDateType as F1, DomPosition as U0, ActionType as Y0, dispose as $5, TooltipIconPosition as Y1, registerOverlay as b5 } from "klinecharts";
function R1(e, t, n) {
...
const x5 = {
  ...
  createPointFigures: ({ coordinates: e }) => {
    if (e.length > 1) {
      ...
      const a = R1({ x: e[1].x - 8, y: e[1].y + 4 }, e[1], r), s = R1({ x: e[1].x - 8, y: e[1].y - 4 }, e[1], r);
      return [
        {
          type: "line",
          attrs: { coordinates: e }
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const n = P9(e[0], e[1]) / Math.sqrt(24), r = e[1].x > e[0].x ? 0 : 1, a = F.getLinearSlopeIntercept(e[0], e[1]);
      let s;
      ...
      for (let c = 2; c < 9; c++) {
        ...
        const P = b + Math.PI / 2, S = R1({ x: C, y: f }, e[0], s);
        l.push({
          ...S,
          r: _,
          startAngle: b,
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    if (e.length > 1) {
      ...
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((f) => {
        ...
        n.push({ coordinates: [{ x: c, y: e[0].y }, { x: c, y: e[1].y }] }), n.push({ coordinates: [{ x: e[0].x, y: _ }, { x: e[1].x, y: _ }] }), r = r.concat($0([e[0], { x: c, y: e[1].y }], t)), r = r.concat($0([e[0], { x: e[1].x, y: _ }], t)), a.unshift({
          x: e[0].x + s,
          y: _ + 10,
          text: `${f.toFixed(3)}`
        }), a.unshift({
...
const Q5 = !1, R5 = (e, t) => e === t, b0 = Symbol("solid-proxy"), z5 = typeof Proxy == "function", U5 = Symbol("solid-track"), e0 = {
  equals: R5
};
let B9 = j9;
const p1 = 1, t0 = 2, O9 = {
...
var N = null;
let v0 = null, Y5 = null, O = null, J = null, h1 = null, c0 = 0;
function J1(e, t) {
  const n = O, r = N, a = e.length === 0, s = t === void 0 ? r : t, o = a ? O9 : {
    owned: null,
    cleanups: null,
...
function $(e, t) {
  ...
  }, r = (a) => (typeof a == "function" && (a = a(n.value)), K9(n, a));
  return [N9.bind(n), r];
}
function V0(e, t, n) {
  const r = C0(e, t, !0, p1);
...
function d1(e, t, n) {
  B9 = ee;
  const r = C0(e, t, !1, p1);
  (!n || !n.render) && (r.user = !0), h1 ? h1.push(r) : T1(r);
}
function c1(e, t, n) {
  n = n ? Object.assign({}, e0, n) : e0;
  const r = C0(e, t, !0, 0);
  return r.observers = null, r.observerSlots = null, r.comparator = n.equals || void 0, T1(r), N9.bind(r);
}
function V5(e) {
...
function H5(e, t, n) {
  ...
  let o = null, i = p0, l = !1, C = "initialValue" in s, f = typeof r == "function" && c1(r);
  const c = /* @__PURE__ */ new Set(), [_, b] = (s.storage || $)(s.initialValue), [P, S] = $(void 0), [L, k] = $(void 0, {
    equals: !1
  }), [T, D] = $(C ? "ready" : "unresolved");
  N && u0(() => {
  ...
  function x(w, M, Y, R) {
    return o === w && (o = null, R !== void 0 && (C = !0), (w === i || M === i) && s.onHydrated && queueMicrotask(() => s.onHydrated(R, {
      value: M
    })), i = p0, W(M, Y)), M;
  }
  function W(w, M) {
    y1(() => {
      M === void 0 && b(() => w), D(M !== void 0 ? "errored" : C ? "ready" : "unresolved"), S(M);
  ...
  function a1() {
    ...
    if (Y !== void 0 && !o)
      throw Y;
    return O && !O.user && w && V0(() => {
      L(), o && (w.resolved || c.has(w) || (w.increment(), c.add(w)));
    }), M;
  }
  function q(w = !0) {
    if (w !== !1 && l)
    ...
    if (Y !== void 0) {
      ...
      return x(o, R, void 0, M), R;
    return o = R, "v" in R ? (R.s === 1 ? x(o, R.v, void 0, M) : x(o, void 0, W1(R.v), M), R) : (l = !0, queueMicrotask(() => l = !1), y1(() => {
      D(C ? "refreshing" : "pending"), k();
    }, !1), R.then((e1) => x(R, e1, void 0, M), (e1) => x(R, void 0, W1(e1), M)));
  }
...
function X5(e) {
  ...
  return Promise.resolve().then(() => {
    O = t, N = n;
    let r;
    return y1(e, !1), O = N = null, r ? r.done : void 0;
  });
}
let J5;
function N9() {
  if (this.sources && this.state)
    if (this.state === p1)
      ...
      const e = J;
      J = null, y1(() => r0(this), !1), J = e;
    }
  if (O) {
    const e = this.observers;
    if (!e || e[e.length - 1] !== O) {
      const t = e ? e.length : 0;
      O.sources ? (O.sources.push(this), O.sourceSlots.push(t)) : (O.sources = [this], O.sourceSlots = [t]), e ? (e.push(O), this.observerSlots.push(O.sources.length - 1)) : (this.observers = [O], this.observerSlots = [O.sources.length - 1]);
    }
  }
  return this.value;
}
function K9(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(r, t)) && (e.value = t, e.observers && e.observers.length && y1(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      const s = e.observers[a], o = v0 && v0.running;
      o && v0.disposed.has(s), (o ? !s.tState : !s.state) && (s.pure ? J.push(s) : h1.push(s), s.observers && F9(s)), o || (s.state = p1);
    }
    if (J.length > 1e6)
      throw J = [], new Error();
  }, !1)), t;
...
function W5(e, t, n) {
  ...
  try {
    ...
    return e.pure && (e.state = p1, e.owned && e.owned.forEach(z1), e.owned = null), e.updatedAt = n + 1, D0(o);
  } finally {
    O = s, N = a;
  }
  (!e.updatedAt || e.updatedAt <= n) && (e.updatedAt != null && "observers" in e ? K9(e, r) : e.value = r, e.updatedAt = n);
}
function C0(e, t, n, r = p1, a) {
  const s = {
    fn: e,
    state: r,
    updatedAt: null,
  ...
  return N === null || N !== O9 && (N.owned ? N.owned.push(s) : N.owned = [s]), s;
}
function n0(e) {
  if (e.state === 0)
    return;
  if (e.state === t0)
    return r0(e);
  if (e.suspense && u1(e.suspense.inFallback))
...
function r0(e, t) {
  ...
  for (let n = 0; n < e.sources.length; n += 1) {
    ...
    if (r.sources) {
      const a = r.state;
      a === p1 ? r !== t && (!r.updatedAt || r.updatedAt < c0) && n0(r) : a === t0 && r0(r, t);
    }
  }
}
function F9(e) {
  for (let t = 0; t < e.observers.length; t += 1) {
    ...
    n.state || (n.state = t0, n.pure ? J.push(n) : h1.push(n), n.observers && F9(n));
  }
}
function z1(e) {
  let t;
...
function ne(e, t, n = {}) {
  ...
  return u0(() => H0(s)), () => {
    ...
    return l[U5], u1(() => {
      let b, P, S, L, k, T, D, x, W;
      if (C === 0)
        o !== 0 && (H0(s), s = [], r = [], a = [], o = 0, i && (i = [])), n.fallback && (r = [te], a[0] = J1((a1) => (s[0] = a1, n.fallback())), o = 1);
      else if (o === 0) {
        for (a = new Array(C), c = 0; c < C; c++)
          r[c] = l[c], a[c] = J1(_);
        o = C;
      } else {
        for (S = new Array(C), L = new Array(C), i && (k = new Array(C)), T = 0, D = Math.min(o, C); T < D && r[T] === l[T]; T++)
          ;
        for (D = o - 1, x = C - 1; D >= T && x >= T && r[D] === l[x]; D--, x--)
          S[x] = a[D], L[x] = s[D], i && (k[x] = i[D]);
        for (b = /* @__PURE__ */ new Map(), P = new Array(x + 1), c = x; c >= T; c--)
          W = l[c], f = b.get(W), P[c] = f === void 0 ? -1 : f, b.set(W, c);
        for (f = T; f <= D; f++)
          W = r[f], c = b.get(W), c !== void 0 && c !== -1 ? (S[c] = a[f], L[c] = s[f], i && (k[c] = i[f]), c = P[c], b.set(W, c)) : s[f]();
        for (c = T; c < C; c++)
          c in S ? (a[c] = S[c], s[c] = L[c], i && (i[c] = k[c], i[c](c))) : a[c] = J1(_);
...
const re = {
  get(e, t, n) {
    return t === b0 ? n : e.get(t);
  },
  has(e, t) {
    return t === b0 ? !0 : e.has(t);
  },
  set: V1,
  deleteProperty: V1,
...
function Z9(...e) {
  ...
  for (let o = 0; o < e.length; o++) {
    const i = e[o];
    t = t || !!i && b0 in i, e[o] = typeof i == "function" ? (t = !0, c1(i)) : i;
  }
  if (z5 && t)
    return new Proxy({
      get(o) {
...
function Q1(e) {
  ...
  return c1(ne(() => e.each, e.children, t || void 0));
}
function U(e) {
  const t = e.keyed, n = c1(() => e.when, void 0, void 0), r = t ? n : c1(n, void 0, {
    equals: (a, s) => !a == !s
  });
  return c1(() => {
    const a = r();
    if (a) {
      const s = e.children;
      return typeof s == "function" && s.length > 0 ? u1(() => s(t ? a : () => {
        if (!u1(r))
          throw ie("Show");
        return n();
      })) : s;
...
function d(e, t, n, r) {
  ...
  }, o = t ? () => u1(() => document.importNode(a || (a = s()), !0)) : () => (a || (a = s())).cloneNode(!0);
  return o.cloneNode = o, o;
}
function C1(e, t = window.document) {
  const n = t[G0] || (t[G0] = /* @__PURE__ */ new Set());
  for (let r = 0, a = e.length; r < a; r++) {
    const s = e[r];
    n.has(s) || (n.add(s), t.addEventListener(s, ce));
  }
}
function X(e, t, n) {
...
function a0(e, t, n, r, a) {
  ...
  if (e = o && n[0] && n[0].parentNode || e, s === "string" || s === "number") {
    ...
    if (o) {
      let i = n[0];
      i && i.nodeType === 3 ? i.data !== t && (i.data = t) : i = document.createTextNode(t), n = S1(e, n, r, i);
    } else
    ...
    if (Array.isArray(t)) {
      ...
      if (x0(i, t, n, a))
        return Q(() => n = a0(e, i, n, r, !0)), () => n;
      if (i.length === 0) {
        if (n = S1(e, n, r), o)
          return n;
      } else
        l ? n.length === 0 ? X0(e, i, r) : se(e, n, i) : (n && S1(e), X0(e, i));
      n = i;
    } else if (t.nodeType) {
      if (Array.isArray(n)) {
        if (o)
    ...
    if (!(i == null || i === !0 || i === !1))
      if ((C = typeof i) == "object" && i.nodeType)
        ...
        if (r) {
          for (; typeof i == "function"; )
            i = i();
          a = x0(e, Array.isArray(i) ? i : [i], Array.isArray(l) ? l : [l]) || a;
        } else
          e.push(i), a = !0;
      else {
        const f = String(i);
...
var ue = typeof H1 == "object" && H1 && H1.Object === Object && H1, R9 = ue, Ce = R9, fe = typeof self == "object" && self && self.Object === Object && self, ge = Ce || fe || Function("return this")(), f1 = ge, de = f1, he = de.Symbol, f0 = he, J0 = f0, z9 = Object.prototype, me = z9.hasOwnProperty, ye = z9.toString, Z1 = J0 ? J0.toStringTag : void 0;
function pe(e) {
  var t = me.call(e, Z1), n = e[Z1];
  try {
    e[Z1] = void 0;
    var r = !0;
  } catch {
...
var ve = pe, _e = Object.prototype, Le = _e.toString;
function $e(e) {
  return Le.call(e);
}
var be = $e, W0 = f0, xe = ve, ke = be, Ae = "[object Null]", we = "[object Undefined]", q0 = W0 ? W0.toStringTag : void 0;
function Me(e) {
  return e == null ? e === void 0 ? we : Ae : q0 && q0 in Object(e) ? xe(e) : ke(e);
}
var U1 = Me;
function Se(e) {
  var t = typeof e;
...
var I1 = Se, Te = U1, De = I1, Ie = "[object AsyncFunction]", Pe = "[object Function]", Be = "[object GeneratorFunction]", Oe = "[object Proxy]";
function Ee(e) {
  if (!De(e))
    return !1;
  var t = Te(e);
  return t == Pe || t == Be || t == Ie || t == Oe;
}
var U9 = Ee, Ne = f1, Ke = Ne["__core-js_shared__"], je = Ke, L0 = je, e9 = function() {
...
var Ze = Fe, Qe = Function.prototype, Re = Qe.toString;
function ze(e) {
  if (e != null) {
    try {
      return Re.call(e);
...
var Y9 = ze, Ue = U9, Ye = Ze, Ve = I1, He = Y9, Ge = /[\\^$.*+?()[\]{}|]/g, Xe = /^\[object .+?Constructor\]$/, Je = Function.prototype, We = Object.prototype, qe = Je.toString, e6 = We.hasOwnProperty, t6 = RegExp(
  "^" + qe.call(e6).replace(Ge, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function n6(e) {
  if (!Ve(e) || Ye(e))
    return !1;
...
var i6 = a6, s6 = r6, o6 = i6;
function l6(e, t) {
  var n = o6(e, t);
  return s6(n) ? n : void 0;
}
var x1 = l6, c6 = x1, u6 = function() {
  try {
...
var H9 = g6, d6 = V9, h6 = H9, m6 = Object.prototype, y6 = m6.hasOwnProperty;
function p6(e, t, n) {
  var r = e[t];
  (!(y6.call(e, t) && h6(r, n)) || n === void 0 && !(t in e)) && d6(e, t, n);
}
var P0 = p6, v6 = Array.isArray, P1 = v6;
function _6(e) {
  return e != null && typeof e == "object";
}
var B1 = _6, L6 = U1, $6 = B1, b6 = "[object Symbol]";
function x6(e) {
  return typeof e == "symbol" || $6(e) && L6(e) == b6;
}
var B0 = x6, k6 = P1, A6 = B0, w6 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, M6 = /^\w*$/;
function S6(e, t) {
  if (k6(e))
    return !1;
  var n = typeof e;
  return n == "number" || n == "symbol" || n == "boolean" || e == null || A6(e) ? !0 : M6.test(e) || !w6.test(e) || t != null && e in Object(t);
}
var T6 = S6, D6 = x1, I6 = D6(Object, "create"), g0 = I6, n9 = g0;
function P6() {
...
var E6 = O6, N6 = g0, K6 = "__lodash_hash_undefined__", j6 = Object.prototype, F6 = j6.hasOwnProperty;
function Z6(e) {
  var t = this.__data__;
  if (N6) {
    var n = t[e];
...
var Q6 = Z6, R6 = g0, z6 = Object.prototype, U6 = z6.hasOwnProperty;
function Y6(e) {
  var t = this.__data__;
  return R6 ? t[e] !== void 0 : U6.call(t, e);
}
var V6 = Y6, H6 = g0, G6 = "__lodash_hash_undefined__";
function X6(e, t) {
  var n = this.__data__;
  return this.size += this.has(e) ? 0 : 1, n[e] = H6 && t === void 0 ? G6 : t, this;
}
var J6 = X6, W6 = B6, q6 = E6, e2 = Q6, t2 = V6, n2 = J6;
function O1(e) {
...
O1.prototype.clear = W6;
O1.prototype.delete = q6;
O1.prototype.get = e2;
O1.prototype.has = t2;
O1.prototype.set = n2;
var r2 = O1;
...
var d0 = o2, l2 = d0, c2 = Array.prototype, u2 = c2.splice;
function C2(e) {
  var t = this.__data__, n = l2(t, e);
  if (n < 0)
    return !1;
  var r = t.length - 1;
  return n == r ? t.pop() : u2.call(t, n, 1), --this.size, !0;
}
var f2 = C2, g2 = d0;
function d2(e) {
  var t = this.__data__, n = g2(t, e);
...
var p2 = y2, v2 = d0;
function _2(e, t) {
  var n = this.__data__, r = v2(n, e);
  return r < 0 ? (++this.size, n.push([e, t])) : n[r][1] = t, this;
}
var L2 = _2, $2 = i2, b2 = f2, x2 = h2, k2 = p2, A2 = L2;
function E1(e) {
  var t = -1, n = e == null ? 0 : e.length;
  for (this.clear(); ++t < n; ) {
    var r = e[t];
...
E1.prototype.clear = $2;
E1.prototype.delete = b2;
E1.prototype.get = x2;
E1.prototype.has = k2;
E1.prototype.set = A2;
var h0 = E1, w2 = x1, M2 = f1, S2 = w2(M2, "Map"), O0 = S2, r9 = r2, T2 = h0, D2 = O0;
function I2() {
...
var Y2 = U2, V2 = m0;
function H2(e, t) {
  var n = V2(this, e), r = n.size;
  return n.set(e, t), this.size += n.size == r ? 0 : 1, this;
}
var G2 = H2, X2 = P2, J2 = F2, W2 = R2, q2 = Y2, e3 = G2;
function N1(e) {
  var t = -1, n = e == null ? 0 : e.length;
  for (this.clear(); ++t < n; ) {
    var r = e[t];
...
N1.prototype.clear = X2;
N1.prototype.delete = J2;
N1.prototype.get = W2;
N1.prototype.has = q2;
N1.prototype.set = e3;
var G9 = N1, X9 = G9, t3 = "Expected a function";
function E0(e, t) {
  ...
  return n.cache = new (E0.Cache || X9)(), n;
}
E0.Cache = X9;
var n3 = E0, r3 = n3, a3 = 500;
function i3(e) {
  var t = r3(e, function(r) {
    return n.size === a3 && n.clear(), r;
  }), n = t.cache;
  return t;
}
var s3 = i3, o3 = s3, l3 = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, c3 = /\\(\\)?/g, u3 = o3(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(l3, function(n, r, a, s) {
    t.push(a ? s.replace(c3, "$1") : r || n);
  }), t;
}), C3 = u3;
function f3(e, t) {
...
var g3 = f3, a9 = f0, d3 = g3, h3 = P1, m3 = B0, y3 = 1 / 0, i9 = a9 ? a9.prototype : void 0, s9 = i9 ? i9.toString : void 0;
function J9(e) {
  if (typeof e == "string")
    return e;
  if (h3(e))
...
var L3 = _3, $3 = P1, b3 = T6, x3 = C3, k3 = L3;
function A3(e, t) {
  return $3(e) ? e : b3(e, t) ? [e] : x3(k3(e));
}
var w3 = A3, M3 = 9007199254740991, S3 = /^(?:0|[1-9]\d*)$/;
function T3(e, t) {
  var n = typeof e;
  return t = t ?? M3, !!t && (n == "number" || n != "symbol" && S3.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
var W9 = T3, D3 = B0, I3 = 1 / 0;
function P3(e) {
  if (typeof e == "string" || D3(e))
    return e;
  var t = e + "";
  return t == "0" && 1 / e == -I3 ? "-0" : t;
}
var B3 = P3, O3 = P0, E3 = w3, N3 = W9, o9 = I1, K3 = B3;
function j3(e, t, n, r) {
  if (!o9(e))
    return e;
  t = E3(t, e);
  for (var a = -1, s = t.length, o = s - 1, i = e; i != null && ++a < s; ) {
    ...
    if (a != o) {
      var f = i[l];
      C = r ? r(f, l, i) : void 0, C === void 0 && (C = o9(f) ? f : N3(t[a + 1]) ? [] : {});
    }
    O3(i, l, C), i = i[l];
  }
  return e;
...
var F3 = j3, Z3 = F3;
function Q3(e, t, n) {
  return e == null ? e : Z3(e, t, n);
}
var R3 = Q3;
const k0 = /* @__PURE__ */ Q9(R3);
var z3 = h0;
function U3() {
...
var W3 = J3, q3 = h0, e8 = O0, t8 = G9, n8 = 200;
function r8(e, t) {
  var n = this.__data__;
  if (n instanceof q3) {
    var r = n.__data__;
    ...
    n = this.__data__ = new t8(r);
  }
  return n.set(e, t), this.size = n.size, this;
}
var a8 = r8, i8 = h0, s8 = Y3, o8 = H3, l8 = X3, c8 = W3, u8 = a8;
function K1(e) {
  var t = this.__data__ = new i8(e);
  this.size = t.size;
}
K1.prototype.clear = s8;
K1.prototype.delete = o8;
K1.prototype.get = l8;
K1.prototype.has = c8;
K1.prototype.set = u8;
var C8 = K1;
...
var g8 = f8, d8 = P0, h8 = V9;
function m8(e, t, n, r) {
  var a = !n;
  n || (n = {});
  for (var s = -1, o = t.length; ++s < o; ) {
    var i = t[s], l = r ? r(n[i], e[i], i, n, e) : void 0;
    l === void 0 && (l = e[i]), a ? h8(n, i, l) : d8(n, i, l);
  }
  return n;
}
var y0 = m8;
...
var p8 = y8, v8 = U1, _8 = B1, L8 = "[object Arguments]";
function $8(e) {
  return _8(e) && v8(e) == L8;
}
var b8 = $8, l9 = b8, x8 = B1, q9 = Object.prototype, k8 = q9.hasOwnProperty, A8 = q9.propertyIsEnumerable, w8 = l9(function() {
  return arguments;
}()) ? l9 : function(e) {
  return x8(e) && k8.call(e, "callee") && !A8.call(e, "callee");
}, M8 = w8, i0 = { exports: {} };
function S8() {
  return !1;
}
...
i0.exports;
(function(e, t) {
  var n = f1, r = T8, a = t && !t.nodeType && t, s = a && !0 && e && !e.nodeType && e, o = s && s.exports === a, i = o ? n.Buffer : void 0, l = i ? i.isBuffer : void 0, C = l || r;
  e.exports = C;
})(i0, i0.exports);
var e5 = i0.exports, D8 = 9007199254740991;
function I8(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= D8;
}
var t5 = I8, P8 = U1, B8 = t5, O8 = B1, E8 = "[object Arguments]", N8 = "[object Array]", K8 = "[object Boolean]", j8 = "[object Date]", F8 = "[object Error]", Z8 = "[object Function]", Q8 = "[object Map]", R8 = "[object Number]", z8 = "[object Object]", U8 = "[object RegExp]", Y8 = "[object Set]", V8 = "[object String]", H8 = "[object WeakMap]", G8 = "[object ArrayBuffer]", X8 = "[object DataView]", J8 = "[object Float32Array]", W8 = "[object Float64Array]", q8 = "[object Int8Array]", e7 = "[object Int16Array]", t7 = "[object Int32Array]", n7 = "[object Uint8Array]", r7 = "[object Uint8ClampedArray]", a7 = "[object Uint16Array]", i7 = "[object Uint32Array]", Z = {};
Z[J8] = Z[W8] = Z[q8] = Z[e7] = Z[t7] = Z[n7] = Z[r7] = Z[a7] = Z[i7] = !0;
Z[E8] = Z[N8] = Z[G8] = Z[K8] = Z[X8] = Z[j8] = Z[F8] = Z[Z8] = Z[Q8] = Z[R8] = Z[z8] = Z[U8] = Z[Y8] = Z[V8] = Z[H8] = !1;
function s7(e) {
  return O8(e) && B8(e.length) && !!Z[P8(e)];
}
var o7 = s7;
function l7(e) {
  return function(t) {
...
var K0 = s0.exports, c7 = o7, u7 = N0, c9 = K0, u9 = c9 && c9.isTypedArray, C7 = u9 ? u7(u9) : c7, f7 = C7, g7 = p8, d7 = M8, h7 = P1, m7 = e5, y7 = W9, p7 = f7, v7 = Object.prototype, _7 = v7.hasOwnProperty;
function L7(e, t) {
  var n = h7(e), r = !n && d7(e), a = !n && !r && m7(e), s = !n && !r && !a && p7(e), o = n || r || a || s, i = o ? g7(e.length, String) : [], l = i.length;
  for (var C in e)
    (t || _7.call(e, C)) && !(o && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var n5 = L7, $7 = Object.prototype;
function b7(e) {
  var t = e && e.constructor, n = typeof t == "function" && t.prototype || $7;
  return e === n;
}
var j0 = b7;
function x7(e, t) {
...
var r5 = x7, k7 = r5, A7 = k7(Object.keys, Object), w7 = A7, M7 = j0, S7 = w7, T7 = Object.prototype, D7 = T7.hasOwnProperty;
function I7(e) {
  if (!M7(e))
    return S7(e);
  var t = [];
  for (var n in Object(e))
    D7.call(e, n) && n != "constructor" && t.push(n);
  return t;
}
var P7 = I7, B7 = U9, O7 = t5;
function E7(e) {
  return e != null && O7(e.length) && !B7(e);
}
var a5 = E7, N7 = n5, K7 = P7, j7 = a5;
function F7(e) {
  return j7(e) ? N7(e) : K7(e);
}
var F0 = F7, Z7 = y0, Q7 = F0;
function R7(e, t) {
  return e && Z7(t, Q7(t), e);
}
var z7 = R7;
function U7(e) {
  var t = [];
...
var Y7 = U7, V7 = I1, H7 = j0, G7 = Y7, X7 = Object.prototype, J7 = X7.hasOwnProperty;
function W7(e) {
  if (!V7(e))
    return G7(e);
  var t = H7(e), n = [];
...
var q7 = W7, et = n5, tt = q7, nt = a5;
function rt(e) {
  return nt(e) ? et(e, !0) : tt(e);
}
var Z0 = rt, at = y0, it = Z0;
function st(e, t) {
  return e && at(t, it(t), e);
}
var ot = st, o0 = { exports: {} };
o0.exports;
(function(e, t) {
  var n = f1, r = t && !t.nodeType && t, a = r && !0 && e && !e.nodeType && e, s = a && a.exports === r, o = s ? n.Buffer : void 0, i = o ? o.allocUnsafe : void 0;
  function l(C, f) {
    if (f)
      return C.slice();
...
var i5 = gt, dt = ft, ht = i5, mt = Object.prototype, yt = mt.propertyIsEnumerable, C9 = Object.getOwnPropertySymbols, pt = C9 ? function(e) {
  return e == null ? [] : (e = Object(e), dt(C9(e), function(t) {
    return yt.call(e, t);
  }));
} : ht, Q0 = pt, vt = y0, _t = Q0;
function Lt(e, t) {
  return vt(e, _t(e), t);
}
var $t = Lt;
...
var s5 = bt, xt = r5, kt = xt(Object.getPrototypeOf, Object), o5 = kt, At = s5, wt = o5, Mt = Q0, St = i5, Tt = Object.getOwnPropertySymbols, Dt = Tt ? function(e) {
  for (var t = []; e; )
    At(t, Mt(e)), e = wt(e);
  return t;
} : St, l5 = Dt, It = y0, Pt = l5;
function Bt(e, t) {
  return It(e, Pt(e), t);
}
var Ot = Bt, Et = s5, Nt = P1;
function Kt(e, t, n) {
  var r = t(e);
  return Nt(e) ? r : Et(r, n(e));
}
var c5 = Kt, jt = c5, Ft = Q0, Zt = F0;
function Qt(e) {
  return jt(e, Zt, Ft);
}
var Rt = Qt, zt = c5, Ut = l5, Yt = Z0;
function Vt(e) {
  return zt(e, Yt, Ut);
}
var Ht = Vt, Gt = x1, Xt = f1, Jt = Gt(Xt, "DataView"), Wt = Jt, qt = x1, e4 = f1, t4 = qt(e4, "Promise"), n4 = t4, r4 = x1, a4 = f1, i4 = r4(a4, "Set"), s4 = i4, o4 = x1, l4 = f1, c4 = o4(l4, "WeakMap"), u4 = c4, A0 = Wt, w0 = O0, M0 = n4, S0 = s4, T0 = u4, u5 = U1, j1 = Y9, f9 = "[object Map]", C4 = "[object Object]", g9 = "[object Promise]", d9 = "[object Set]", h9 = "[object WeakMap]", m9 = "[object DataView]", f4 = j1(A0), g4 = j1(w0), d4 = j1(M0), h4 = j1(S0), m4 = j1(T0), b1 = u5;
(A0 && b1(new A0(new ArrayBuffer(1))) != m9 || w0 && b1(new w0()) != f9 || M0 && b1(M0.resolve()) != g9 || S0 && b1(new S0()) != d9 || T0 && b1(new T0()) != h9) && (b1 = function(e) {
  var t = u5(e), n = t == C4 ? e.constructor : void 0, r = n ? j1(n) : "";
  if (r)
    switch (r) {
      case f4:
        return m9;
...
var R0 = b1, y4 = Object.prototype, p4 = y4.hasOwnProperty;
function v4(e) {
  var t = e.length, n = new e.constructor(t);
  return t && typeof e[0] == "string" && p4.call(e, "index") && (n.index = e.index, n.input = e.input), n;
}
var _4 = v4, L4 = f1, $4 = L4.Uint8Array, b4 = $4, y9 = b4;
function x4(e) {
  var t = new e.constructor(e.byteLength);
  return new y9(t).set(new y9(e)), t;
}
var z0 = x4, k4 = z0;
function A4(e, t) {
  var n = t ? k4(e.buffer) : e.buffer;
...
var T4 = S4, p9 = f0, v9 = p9 ? p9.prototype : void 0, _9 = v9 ? v9.valueOf : void 0;
function D4(e) {
  return _9 ? Object(_9.call(e)) : {};
}
var I4 = D4, P4 = z0;
function B4(e, t) {
...
var O4 = B4, E4 = z0, N4 = w4, K4 = T4, j4 = I4, F4 = O4, Z4 = "[object Boolean]", Q4 = "[object Date]", R4 = "[object Map]", z4 = "[object Number]", U4 = "[object RegExp]", Y4 = "[object Set]", V4 = "[object String]", H4 = "[object Symbol]", G4 = "[object ArrayBuffer]", X4 = "[object DataView]", J4 = "[object Float32Array]", W4 = "[object Float64Array]", q4 = "[object Int8Array]", en = "[object Int16Array]", tn = "[object Int32Array]", nn = "[object Uint8Array]", rn = "[object Uint8ClampedArray]", an = "[object Uint16Array]", sn = "[object Uint32Array]";
function on(e, t, n) {
  var r = e.constructor;
  switch (t) {
    case G4:
...
var ln = on, cn = I1, L9 = Object.create, un = function() {
  function e() {
  }
  return function(t) {
    if (!cn(t))
...
}(), Cn = un, fn = Cn, gn = o5, dn = j0;
function hn(e) {
  return typeof e.constructor == "function" && !dn(e) ? fn(gn(e)) : {};
}
var mn = hn, yn = R0, pn = B1, vn = "[object Map]";
function _n(e) {
  return pn(e) && yn(e) == vn;
}
var Ln = _n, $n = Ln, bn = N0, $9 = K0, b9 = $9 && $9.isMap, xn = b9 ? bn(b9) : $n, kn = xn, An = R0, wn = B1, Mn = "[object Set]";
function Sn(e) {
  return wn(e) && An(e) == Mn;
}
var Tn = Sn, Dn = Tn, In = N0, x9 = K0, k9 = x9 && x9.isSet, Pn = k9 ? In(k9) : Dn, Bn = Pn, On = C8, En = g8, Nn = P0, Kn = z7, jn = ot, Fn = lt, Zn = ut, Qn = $t, Rn = Ot, zn = Rt, Un = Ht, Yn = R0, Vn = _4, Hn = ln, Gn = mn, Xn = P1, Jn = e5, Wn = kn, qn = I1, er = Bn, tr = F0, nr = Z0, rr = 1, ar = 2, ir = 4, C5 = "[object Arguments]", sr = "[object Array]", or = "[object Boolean]", lr = "[object Date]", cr = "[object Error]", f5 = "[object Function]", ur = "[object GeneratorFunction]", Cr = "[object Map]", fr = "[object Number]", g5 = "[object Object]", gr = "[object RegExp]", dr = "[object Set]", hr = "[object String]", mr = "[object Symbol]", yr = "[object WeakMap]", pr = "[object ArrayBuffer]", vr = "[object DataView]", _r = "[object Float32Array]", Lr = "[object Float64Array]", $r = "[object Int8Array]", br = "[object Int16Array]", xr = "[object Int32Array]", kr = "[object Uint8Array]", Ar = "[object Uint8ClampedArray]", wr = "[object Uint16Array]", Mr = "[object Uint32Array]", j = {};
j[C5] = j[sr] = j[pr] = j[vr] = j[or] = j[lr] = j[_r] = j[Lr] = j[$r] = j[br] = j[xr] = j[Cr] = j[fr] = j[g5] = j[gr] = j[dr] = j[hr] = j[mr] = j[kr] = j[Ar] = j[wr] = j[Mr] = !0;
j[cr] = j[f5] = j[yr] = !1;
function q1(e, t, n, r, a, s) {
  var o, i = t & rr, l = t & ar, C = t & ir;
  ...
  if (f) {
    ...
    var c = Yn(e), _ = c == f5 || c == ur;
    if (Jn(e))
      return Fn(e, i);
    if (c == g5 || c == C5 || _ && !a) {
      if (o = l || _ ? {} : Gn(e), !i)
        return l ? Rn(e, jn(o, e)) : Qn(e, Kn(o, e));
    } else {
      if (!j[c])
        return a ? e : {};
      o = Hn(e, c, i);
  ...
  if (b)
    return b;
  s.set(e, o), er(e) ? e.forEach(function(L) {
    o.add(q1(L, t, n, L, e, s));
  }) : Wn(e) && e.forEach(function(L, k) {
    o.set(k, q1(L, t, n, k, e, s));
  });
  var P = C ? l ? Un : zn : l ? nr : tr, S = f ? void 0 : P(e);
  return En(S || e, function(L, k) {
    S && (k = L, L = e[k]), Nn(o, k, q1(L, t, n, k, e, s));
  }), o;
}
var Sr = q1, Tr = Sr, Dr = 1, Ir = 4;
function Pr(e) {
  return Tr(e, Dr | Ir);
}
var Br = Pr;
const Or = /* @__PURE__ */ Q9(Br);
var Er = /* @__PURE__ */ d("<button>");
const Nr = (e) => (() => {
  var t = Er();
  return L1(t, "click", e.onClick, !0), m(t, () => e.children), Q((n) => {
    var r = e.style, a = `klinecharts-pro-button ${e.type ?? "confirm"} ${e.class ?? ""}`;
    return n.e = D1(t, r, n.e), a !== n.t && m1(t, n.t = a), n;
  }, {
    e: void 0,
    t: void 0
  }), t;
...
C1(["click"]);
var Kr = /* @__PURE__ */ d('<svg viewBox="0 0 1024 1024"class=icon><path d="M810.666667 128H213.333333c-46.933333 0-85.333333 38.4-85.333333 85.333333v597.333334c0 46.933333 38.4 85.333333 85.333333 85.333333h597.333334c46.933333 0 85.333333-38.4 85.333333-85.333333V213.333333c0-46.933333-38.4-85.333333-85.333333-85.333333z m-353.706667 567.04a42.496 42.496 0 0 1-60.16 0L243.626667 541.866667c-8.106667-8.106667-12.373333-18.773333-12.373334-29.866667s4.693333-22.186667 12.373334-29.866667a42.496 42.496 0 0 1 60.16 0L426.666667 604.586667l293.546666-293.546667a42.496 42.496 0 1 1 60.16 60.16l-323.413333 323.84z">'), jr = /* @__PURE__ */ d('<svg viewBox="0 0 1024 1024"class=icon><path d="M245.333333 128h533.333334A117.333333 117.333333 0 0 1 896 245.333333v533.333334A117.333333 117.333333 0 0 1 778.666667 896H245.333333A117.333333 117.333333 0 0 1 128 778.666667V245.333333A117.333333 117.333333 0 0 1 245.333333 128z m0 64c-29.44 0-53.333333 23.893333-53.333333 53.333333v533.333334c0 29.44 23.893333 53.333333 53.333333 53.333333h533.333334c29.44 0 53.333333-23.893333 53.333333-53.333333V245.333333c0-29.44-23.893333-53.333333-53.333333-53.333333H245.333333z">'), Fr = /* @__PURE__ */ d("<div>"), Zr = /* @__PURE__ */ d("<span class=label>");
const Qr = () => Kr(), Rr = () => jr(), A9 = (e) => {
  ...
  return d1(() => {
    ...
    return r.$$click = (a) => {
      ...
      return a.e = D1(r, s, a.e), o !== a.t && m1(r, a.t = o), a;
    }, {
      e: void 0,
      t: void 0
    }), r;
...
const l0 = (e) => (() => {
  ...
  return m(t, y(U, {
    ...
    get when() {
      var n;
      return G(() => !e.loading && !e.children)() && !((n = e.dataSource) != null && n.length);
    },
    get children() {
      return y(Yr, {});
    }
    ...
    get children() {
      ...
      return (n = e.dataSource) == null ? void 0 : n.map((r) => {
        var a;
        return ((a = e.renderItem) == null ? void 0 : a.call(e, r)) ?? Hr();
      });
    }
  }), null), Q((n) => {
...
var Gr = /* @__PURE__ */ d('<div class=klinecharts-pro-modal><div class=inner><div class=title-container><svg class=close-icon viewBox="0 0 1024 1024"><path d="M934.184927 199.723787 622.457206 511.452531l311.727721 311.703161c14.334473 14.229073 23.069415 33.951253 23.069415 55.743582 0 43.430138-35.178197 78.660524-78.735226 78.660524-21.664416 0-41.361013-8.865925-55.642275-23.069415L511.149121 622.838388 199.420377 934.490384c-14.204513 14.20349-33.901111 23.069415-55.642275 23.069415-43.482327 0-78.737272-35.230386-78.737272-78.660524 0-21.792329 8.864902-41.513486 23.094998-55.743582l311.677579-311.703161L88.135828 199.723787c-14.230096-14.255679-23.094998-33.92567-23.094998-55.642275 0-43.430138 35.254945-78.762855 78.737272-78.762855 21.741163 0 41.437761 8.813736 55.642275 23.069415l311.727721 311.727721L822.876842 88.389096c14.281261-14.255679 33.977859-23.069415 55.642275-23.069415 43.557028 0 78.735226 35.332716 78.735226 78.762855C957.254342 165.798117 948.5194 185.468109 934.184927 199.723787"></path></svg></div><div class=content-container>'), Xr = /* @__PURE__ */ d("<div class=button-container>");
const k1 = (e) => (() => {
  var t = Gr(), n = t.firstChild, r = n.firstChild, a = r.firstChild, s = r.nextSibling;
  return m(r, () => e.title, a), L1(a, "click", e.onClose, !0), m(s, () => e.children), m(n, (() => {
    var o = G(() => !!(e.buttons && e.buttons.length > 0));
    return () => o() && (() => {
      var i = Xr();
      return m(i, () => e.buttons.map((l) => y(Nr, Z9(l, {
        get children() {
          return l.children;
        }
      })))), i;
    })();
  })(), null), Q((o) => le(n, "width", `${e.width ?? 400}px`)), t;
})();
C1(["click"]);
var Jr = /* @__PURE__ */ d("<div tabindex=0><div class=selector-container><span class=value></span><i class=arrow>"), Wr = /* @__PURE__ */ d("<div class=drop-down-container><ul>"), qr = /* @__PURE__ */ d("<li>");
const h5 = (e) => {
  const [t, n] = $(!1);
  return (() => {
    var r = Jr(), a = r.firstChild, s = a.firstChild;
    return r.addEventListener("blur", (o) => {
      n(!1);
    }), r.$$click = (o) => {
      n((i) => !i);
    }, m(s, () => e.value), m(r, (() => {
      var o = G(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => o() && (() => {
        var i = Wr(), l = i.firstChild;
        return m(l, () => e.dataSource.map((C) => {
          const c = C[e.valueKey ?? "text"] ?? C;
          return (() => {
            var _ = qr();
            return _.$$click = (b) => {
              var P;
              b.stopPropagation(), e.value !== c && ((P = e.onSelected) == null || P.call(e, C)), n(!1);
            }, m(_, c), _;
          })();
        })), i;
      })();
      ...
      return o.e = D1(r, i, o.e), l !== o.t && m1(r, o.t = l), o;
    }, {
      e: void 0,
      t: void 0
    }), r;
...
C1(["click"]);
var ea = /* @__PURE__ */ d("<span class=prefix>"), ta = /* @__PURE__ */ d("<span class=suffix>"), na = /* @__PURE__ */ d("<div><input class=value>");
const m5 = (e) => {
  const t = Z9({
  ...
  return (() => {
    ...
    return s.$$click = () => {
      ...
      return i.e = D1(s, l, i.e), C !== i.t && m1(s, i.t = C), f !== i.a && X(s, "data-status", i.a = f), c !== i.o && X(o, "placeholder", i.o = c), i;
    }, {
      e: void 0,
      t: void 0,
      a: void 0,
...
C1(["click"]);
var ra = /* @__PURE__ */ d("<div><i class=thumb>");
const aa = (e) => (() => {
  var t = ra();
  return t.$$click = (n) => {
...
C1(["click"]);
const ia = "指标", sa = "主图指标", oa = "副图指标", la = "设置", ca = "时区", ua = "截屏", Ca = "全屏", fa = "退出全屏", ga = "保存", da = "确定", ha = "取消", ma = "MA(移动平均线)", ya = "EMA(指数平滑移动平均线)", pa = "SMA", va = "BOLL(布林线)", _a = "BBI(多空指数)", La = "SAR(停损点指向指标)", $a = "VOL(成交量)", ba = "MACD(指数平滑异同移动平均线)", xa = "KDJ(随机指标)", ka = "RSI(相对强弱指标)", Aa = "BIAS(乖离率)", wa = "BRAR(情绪指标)", Ma = "CCI(顺势指标)", Sa = "DMI(动向指标)", Ta = "CR(能量指标)", Da = "PSY(心理线)", Ia = "DMA(平行线差指标)", Pa = "TRIX(三重指数平滑平均线)", Ba = "OBV(能量潮指标)", Oa = "VR(成交量变异率)", Ea = "WR(威廉指标)", Na = "MTM(动量指标)", Ka = "EMV(简易波动指标)", ja = "ROC(变动率指标)", Fa = "PVT(价量趋势指标)", Za = "AO(动量震荡指标)", Qa = "世界统一时间", Ra = "(UTC-10) 檀香山", za = "(UTC-8) 朱诺", Ua = "(UTC-7) 洛杉矶", Ya = "(UTC-5) 芝加哥", Va = "(UTC-4) 多伦多", Ha = "(UTC-3) 圣保罗", Ga = "(UTC+1) 伦敦", Xa = "(UTC+2) 柏林", Ja = "(UTC+3) 巴林", Wa = "(UTC+4) 迪拜", qa = "(UTC+5) 阿什哈巴德", ei = "(UTC+6) 阿拉木图", ti = "(UTC+7) 曼谷", ni = "(UTC+8) 上海", ri = "(UTC+9) 东京", ai = "(UTC+10) 悉尼", ii = "(UTC+12) 诺福克岛", si = "水平直线", oi = "水平射线", li = "水平线段", ci = "垂直直线", ui = "垂直射线", Ci = "垂直线段", fi = "直线", gi = "射线", di = "线段", hi = "箭头", mi = "价格线", yi = "价格通道线", pi = "平行直线", vi = "斐波那契回调直线", _i = "斐波那契回调线段", Li = "斐波那契圆环", $i = "斐波那契螺旋", bi = "斐波那契速度阻力扇", xi = "斐波那契趋势扩展", ki = "江恩箱", Ai = "矩形", wi = "平行四边形", Mi = "圆", Si = "三角形", Ti = "三浪", Di = "五浪", Ii = "八浪", Pi = "任意浪", Bi = "ABCD形态", Oi = "XABCD形态", Ei = "弱磁模式", Ni = "强磁模式", Ki = "商品搜索", ji = "商品代码", Fi = "参数1", Zi = "参数2", Qi = "参数3", Ri = "参数4", zi = "参数5", Ui = "周期", Yi = "标准差", Vi = "全部周期", Hi = "全部周期", Gi = "固定", Xi = "取消固定", Ji = "已固定", Wi = "拖放到此保存为快速周期", qi = "将上方周期拖放到此区域", es = "点击移除", ts = "仅实时", ns = "秒", rs = "分钟", as = "小时", is = "天", ss = "周", os = "月", ls = "周/月", cs = "蜡烛图类型", us = "全实心", Cs = "全空心", fs = "涨空心", gs = "跌空心", ds = "OHLC", hs = "面积图", ms = "最新价显示", ys = "最高价显示", ps = "最低价显示", vs = "指标最新值显示", _s = "价格轴类型", Ls = "线性轴", $s = "百分比轴", bs = "对数轴", xs = "倒置坐标", ks = "网格线显示", As = "恢复默认", ws = {
  indicator: ia,
  main_indicator: sa,
  sub_indicator: oa,
  setting: la,
  ...
  sydney: ai,
  norfolk: ii,
  horizontal_straight_line: si,
  horizontal_ray_line: oi,
  horizontal_segment: li,
  vertical_straight_line: ci,
  vertical_ray_line: ui,
  vertical_segment: Ci,
  straight_line: fi,
  ray_line: gi,
  segment: di,
  ...
  fibonacci_line: vi,
  fibonacci_segment: _i,
  fibonacci_circle: Li,
  fibonacci_spiral: $i,
  fibonacci_speed_resistance_fan: bi,
  fibonacci_extension: xi,
  gann_box: ki,
  rect: Ai,
  parallelogram: wi,
  circle: Mi,
  ...
  high_price_show: ys,
  low_price_show: ps,
  indicator_last_value_show: vs,
  price_axis_type: _s,
  normal: Ls,
  percentage: $s,
  log: bs,
  reverse_coordinate: xs,
  grid_show: ks,
  restore_default: As
}, Ms = "Indicator", Ss = "Main Indicator", Ts = "Sub Indicator", Ds = "Setting", Is = "Timezone", Ps = "Screenshot", Bs = "Full Screen", Os = "Exit", Es = "Save", Ns = "Confirm", Ks = "Cancel", js = "MA(Moving Average)", Fs = "EMA(Exponential Moving Average)", Zs = "SMA", Qs = "BOLL(Bolinger Bands)", Rs = "BBI(Bull And Bearlndex)", zs = "SAR(Stop and Reverse)", Us = "VOL(Volume)", Ys = "MACD(Moving Average Convergence / Divergence)", Vs = "KDJ(KDJ Index)", Hs = "RSI(Relative Strength Index)", Gs = "BIAS(Bias Ratio)", Xs = "BRAR(情绪指标)", Js = "CCI(Commodity Channel Index)", Ws = "DMI(Directional Movement Index)", qs = "CR(能量指标)", eo = "PSY(Psychological Line)", to = "DMA(Different of Moving Average)", no = "TRIX(Triple Exponentially Smoothed Moving Average)", ro = "OBV(On Balance Volume)", ao = "VR(Volatility Volume Ratio)", io = "WR(Williams %R)", so = "MTM(Momentum Index)", oo = "EMV(Ease of Movement Value)", lo = "ROC(Price Rate of Change)", co = "PVT(Price and Volume Trend)", uo = "AO(Awesome Oscillator)", Co = "UTC", fo = "(UTC-10) Honolulu", go = "(UTC-8) Juneau", ho = "(UTC-7) Los Angeles", mo = "(UTC-5) Chicago", yo = "(UTC-4) Toronto", po = "(UTC-3) Sao Paulo", vo = "(UTC+1) London", _o = "(UTC+2) Berlin", Lo = "(UTC+3) Bahrain", $o = "(UTC+4) Dubai", bo = "(UTC+5) Ashkhabad", xo = "(UTC+6) Almaty", ko = "(UTC+7) Bangkok", Ao = "(UTC+8) Shanghai", wo = "(UTC+9) Tokyo", Mo = "(UTC+10) Sydney", So = "(UTC+12) Norfolk", To = "Horizontal Line", Do = "Horizontal Ray", Io = "Horizontal Segment", Po = "Vertical Line", Bo = "Vertical Ray", Oo = "Vertical Segment", Eo = "Trend Line", No = "Ray", Ko = "Segment", jo = "Arrow", Fo = "Price Line", Zo = "Price Channel Line", Qo = "Parallel Line", Ro = "Fibonacci Line", zo = "Fibonacci Segment", Uo = "Fibonacci Circle", Yo = "Fibonacci Spiral", Vo = "Fibonacci Sector", Ho = "Fibonacci Extension", Go = "Gann Box", Xo = "Rect", Jo = "Parallelogram", Wo = "Circle", qo = "Triangle", el = "Three Waves", tl = "Five Waves", nl = "Eight Waves", rl = "Any Waves", al = "ABCD Pattern", il = "XABCD Pattern", sl = "Weak Magnet", ol = "Strong Magnet", ll = "Symbol Search", cl = "Symbol Code", ul = "Parameter 1", Cl = "Parameter 2", fl = "Parameter 3", gl = "Parameter 4", dl = "Parameter 5", hl = "Period", ml = "Standard Deviation", yl = "All Periods", pl = "All Periods", vl = "Pin", _l = "Unpin", Ll = "Pinned", $l = "Drop here to pin as a quick period", bl = "Drag a period from above to this area", xl = "Click to remove", kl = "Realtime", Al = "Seconds", wl = "Minutes", Ml = "Hours", Sl = "Days", Tl = "Weeks", Dl = "Months", Il = "Weekly/Monthly", Pl = "Candle Type", Bl = "Candle Solid", Ol = "Candle Stroke", El = "Candle Up Stroke", Nl = "Candle Down Stroke", Kl = "OHLC", jl = "Area", Fl = "Show Last Price", Zl = "Show Highest Price", Ql = "Show Lowest Price", Rl = "Show indicator's last value", zl = "Price Axis Type", Ul = "Normal", Yl = "Percentage", Vl = "Log", Hl = "Reverse Coordinate", Gl = "Show Grids", Xl = "Restore Defaults", Jl = {
  indicator: Ms,
  main_indicator: Ss,
  sub_indicator: Ts,
  setting: Ds,
  ...
  arrow: jo,
  price_line: Fo,
  price_channel_line: Zo,
  parallel_straight_line: Qo,
  fibonacci_line: Ro,
  fibonacci_segment: zo,
  fibonacci_circle: Uo,
  fibonacci_spiral: Yo,
  fibonacci_speed_resistance_fan: Vo,
  fibonacci_extension: Ho,
  gann_box: Go,
  rect: Xo,
  parallelogram: Jo,
  circle: Wo,
  ...
  candle_stroke: Ol,
  candle_up_stroke: El,
  candle_down_stroke: Nl,
  ohlc: Kl,
  area: jl,
  last_price_show: Fl,
  high_price_show: Zl,
  low_price_show: Ql,
  indicator_last_value_show: Rl,
  price_axis_type: zl,
  normal: Ul,
  percentage: Yl,
  log: Vl,
  reverse_coordinate: Hl,
  grid_show: Gl,
  restore_default: Xl
}, y5 = {
  "zh-CN": ws,
...
const uc = (e) => {
  ...
  return E9(() => {
    ...
    document.removeEventListener("fullscreenchange", S), document.removeEventListener("mozfullscreenchange", S), document.removeEventListener("webkitfullscreenchange", S), document.removeEventListener("msfullscreenchange", S);
  }), (() => {
    var L = tc(), k = L.firstChild, T = k.firstChild, D = k.nextSibling, x = D.nextSibling, W = x.firstChild, a1 = W.nextSibling, q = x.nextSibling, g1 = q.firstChild, w = g1.nextSibling, M = q.nextSibling, Y = M.firstChild, R = Y.nextSibling, e1 = M.nextSibling, A1 = e1.firstChild, w1 = A1.nextSibling, v1 = e1.nextSibling;
    return I0((A) => {
      t = A;
    }, L), L1(T, "click", e.onMenuClick, !0), m(L, y(U, {
      get when() {
        return e.symbol;
      },
      get children() {
        var A = ql(), K = A.firstChild;
        return L1(A, "click", e.onSymbolClick, !0), m(A, y(U, {
          get when() {
            return e.symbol.logo;
          },
          get children() {
            var i1 = Wl();
            return Q(() => X(i1, "src", e.symbol.logo)), i1;
          }
        }), K), m(K, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), A;
      }
    }), D), m(L, y(Q1, {
      get each() {
        return l();
      ...
      children: (A) => (() => {
        ...
        return K.$$click = () => {
          e.onPeriodChange(A);
        }, m(K, () => A.text), Q(() => m1(K, `item period ${A.text === e.period.text ? "selected" : ""}`)), K;
      })()
    }), D), D.$$click = () => {
      s(!0);
    }, m(L, y(U, {
      ...
      get children() {
        return y(k1, {
          width: 360,
          get title() {
            return u("expand_periods", e.locale);
          },
          onClose: () => {
            s(!1);
          },
          get children() {
            var A = ec(), K = A.firstChild, i1 = K.firstChild, I = i1.nextSibling, z = K.nextSibling, t1 = z.firstChild, l1 = t1.firstChild, $1 = t1.nextSibling;
            return m(i1, () => u("all_periods", e.locale)), m(I, y(Q1, {
              get each() {
                return lc(e.periods);
              },
              children: (n1) => (() => {
                var s1 = nc(), V = s1.firstChild, g = V.nextSibling;
                return m(V, () => u(n1.unit, e.locale)), m(g, y(Q1, {
                  get each() {
                    return n1.periods;
                  },
                  children: (v) => {
                    var B;
                    const p = ((B = e.pinnedTimeframes) == null ? void 0 : B.includes(v.text)) ?? !1, h = v.text === e.period.text;
                    return (() => {
                      var E = G1();
                      return E.addEventListener("dragstart", (H) => {
                        ...
                        e.onPeriodChange(v);
                      }, m1(E, `period-pill ${p ? "pinned" : ""} ${h ? "selected" : ""}`), X(E, "draggable", !0), m(E, () => v.text, null), m(E, (() => {
                        var H = G(() => !!cc(v));
                        return () => H() ? (() => {
                          var r1 = rc();
                          return m(r1, () => u("realtime_only", e.locale)), r1;
                        })() : null;
                      })(), null), E;
                    })();
                  }
            ...
            })), z.addEventListener("drop", P), z.addEventListener("dragleave", b), z.addEventListener("dragover", _), m(t1, () => u("pinned", e.locale), l1), m(l1, () => u("pin_hint", e.locale)), m($1, y(U, {
              get when() {
                return (e.pinnedTimeframes ?? []).length > 0;
              },
              get fallback() {
                return (() => {
                  var n1 = ac();
                  return m(n1, () => u("pin_empty", e.locale)), n1;
                })();
              },
              get children() {
                return y(Q1, {
                  get each() {
                    return e.pinnedTimeframes ?? [];
                  },
                  children: (n1) => {
                    const s1 = e.periods.find((V) => V.text === n1);
                    return (() => {
                      var V = ic(), g = V.firstChild, v = g.nextSibling;
                      return V.$$click = () => {
                        f(n1);
                      }, m(v, () => s1 ? s1.text : n1), Q(() => X(V, "title", u("pin_remove", e.locale))), V;
                    })();
                  }
                });
              }
            })), Q(() => m1(z, `klinecharts-pro-period-pin ${o() ? "drop-active" : ""}`)), A;
          }
        });
      }
    }), x), L1(x, "click", e.onIndicatorClick, !0), m(a1, () => u("indicator", e.locale)), L1(q, "click", e.onTimezoneClick, !0), m(w, () => u("timezone", e.locale)), L1(M, "click", e.onSettingClick, !0), m(R, () => u("setting", e.locale)), L1(e1, "click", e.onScreenshotClick, !0), m(w1, () => u("screenshot", e.locale)), v1.$$click = () => {
      if (n())
        ...
        A && (A.requestFullscreen ?? A.webkitRequestFullscreen ?? A.mozRequestFullScreen ?? A.msRequestFullscreen).call(A);
      }
    }, m(v1, (() => {
      var A = G(() => !!n());
      return () => A() ? [sc(), (() => {
      ...
      var K = e.spread ? "" : "rotate", i1 = u("expand_periods", e.locale);
      return K !== A.e && X(T, "class", A.e = K), i1 !== A.t && X(D, "title", A.t = i1), A;
    }, {
      e: void 0,
      t: void 0
    }), L;
...
const Tu = () => Su(), Du = {
  ...
  priceLine: Ic,
  priceChannelLine: Bc,
  parallelStraightLine: Ec,
  fibonacciLine: Kc,
  fibonacciSegment: Fc,
  fibonacciCircle: Qc,
  fibonacciSpiral: zc,
  fibonacciSpeedResistanceFan: Yc,
  fibonacciExtension: Hc,
  gannBox: Xc,
  circle: Wc,
  triangle: eu,
  rect: nu,
...
const o1 = (e) => Du[e.name](e.class);
var Ku = /* @__PURE__ */ d('<div class=klinecharts-pro-drawing-bar><span class=split-line></span><div class=item tabindex=0><span style=width:32px;height:32px></span><div class=icon-arrow><svg viewBox="0 0 4 6"><path d=M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z stroke=none stroke-opacity=0></path></svg></div></div><div class=item><span style=width:32px;height:32px></span></div><div class=item><span style=width:32px;height:32px></span></div><span class=split-line></span><div class=item><span style=width:32px;height:32px>'), ju = /* @__PURE__ */ d('<div class=item tabindex=0><span style=width:32px;height:32px></span><div class=icon-arrow><svg viewBox="0 0 4 6"><path d=M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z stroke=none stroke-opacity=0>'), w9 = /* @__PURE__ */ d("<li><span style=padding-left:8px>");
const M9 = "drawing_tools", Fu = (e) => {
  const [t, n] = $("horizontalStraightLine"), [r, a] = $("priceChannelLine"), [s, o] = $("circle"), [i, l] = $("fibonacciLine"), [C, f] = $("xabcd"), [c, _] = $("weak_magnet"), [b, P] = $("normal"), [S, L] = $(!1), [k, T] = $(!0), [D, x] = $(""), W = c1(() => [{
    key: "singleLine",
    icon: t(),
    list: Iu(e.locale),
    setter: n
  ...
  return (() => {
    var q = Ku(), g1 = q.firstChild, w = g1.nextSibling, M = w.firstChild, Y = M.nextSibling, R = Y.firstChild, e1 = w.nextSibling, A1 = e1.firstChild, w1 = e1.nextSibling, v1 = w1.firstChild, A = w1.nextSibling, K = A.nextSibling, i1 = K.firstChild;
    return m(q, () => W().map((I) => (() => {
      var z = ju(), t1 = z.firstChild, l1 = t1.nextSibling, $1 = l1.firstChild;
      ...
      })(), null), Q(() => X($1, "class", I.key === D() ? "rotate" : "")), z;
    })()), g1), w.addEventListener("blur", () => {
      x("");
    }), M.$$click = () => {
      let I = c();
      b() !== "normal" && (I = "normal"), P(I), e.onModeChange(I);
    }, m(M, (() => {
      var I = G(() => c() === "weak_magnet");
      return () => I() ? G(() => b() === "weak_magnet")() ? y(o1, {
        name: "weak_magnet",
        class: "selected"
      }) : y(o1, {
        name: "weak_magnet"
      }) : G(() => b() === "strong_magnet")() ? y(o1, {
        name: "strong_magnet",
        class: "selected"
      }) : y(o1, {
        name: "strong_magnet"
      ...
      return () => I() && y(l0, {
        ...
        get children() {
          return a1().map((z) => (() => {
            var t1 = w9(), l1 = t1.firstChild;
            return t1.$$click = () => {
              _(z.key), P(z.key), e.onModeChange(z.key), x("");
            }, m(t1, y(o1, {
              get name() {
                return z.key;
              }
      ...
      name: "remove"
    })), Q(() => X(R, "class", D() === "mode" ? "rotate" : "")), q;
  })();
};
C1(["click"]);
var S9 = /* @__PURE__ */ d("<li class=title>"), T9 = /* @__PURE__ */ d("<li class=row>");
const Zu = (e) => y(k1, {
  get title() {
...
const Ru = (e) => {
  const [t, n] = $(e.timezone), r = c1(() => Qu(e.locale));
  return y(k1, {
    get title() {
...
var zu = /* @__PURE__ */ d("<div class=klinecharts-pro-setting-modal-content>"), Uu = /* @__PURE__ */ d("<span>");
const Yu = (e) => {
  const [t, n] = $(e.currentStyles), [r, a] = $(I9(e.locale));
  d1(() => {
    a(I9(e.locale));
  });
  const s = (o, i) => {
...
var Vu = /* @__PURE__ */ d("<img style=width:500px;margin-top:20px>");
const Hu = (e) => y(k1, {
  get title() {
...
var Xu = /* @__PURE__ */ d("<div class=klinecharts-pro-indicator-setting-modal-content>"), Ju = /* @__PURE__ */ d("<span>");
const Wu = (e) => {
  const [t, n] = $(F.clone(e.params.calcParams)), r = (a) => Gu[a];
  return y(k1, {
    get title() {
    ...
    get buttons() {
      return [{
        ...
        onClick: () => {
          ...
          F.clone(t()).forEach((o, i) => {
            !F.isValid(o) || o === "" ? "default" in a[i] && s.push(a[i].default) : s.push(o);
...
var qu = /* @__PURE__ */ d('<svg viewBox="0 0 1024 1024"><path d="M945.066667 898.133333l-189.866667-189.866666c55.466667-64 87.466667-149.333333 87.466667-241.066667 0-204.8-168.533333-373.333333-373.333334-373.333333S96 264.533333 96 469.333333 264.533333 842.666667 469.333333 842.666667c91.733333 0 174.933333-34.133333 241.066667-87.466667l189.866667 189.866667c6.4 6.4 14.933333 8.533333 23.466666 8.533333s17.066667-2.133333 23.466667-8.533333c8.533333-12.8 8.533333-34.133333-2.133333-46.933334zM469.333333 778.666667C298.666667 778.666667 160 640 160 469.333333S298.666667 160 469.333333 160 778.666667 298.666667 778.666667 469.333333 640 778.666667 469.333333 778.666667z">'), eC = /* @__PURE__ */ d("<img alt=symbol>"), tC = /* @__PURE__ */ d("<li><div><span>");
const nC = (e) => {
  const [t, n] = $(""), [r] = H5(t, e.datafeed.searchSymbols.bind(e.datafeed));
  return y(k1, {
    get title() {
    ...
    get children() {
      return [y(m5, {
        ...
        renderItem: (a) => (() => {
          var s = tC(), o = s.firstChild, i = o.firstChild;
          return s.$$click = () => {
            ...
            get children() {
              var l = eC();
              return Q(() => X(l, "src", a.logo)), l;
            }
          }), i), m(i, () => a.shortName ?? a.ticker, null), m(i, () => `${a.name ? `(${a.name})` : ""}`, null), m(s, () => a.exchange ?? "", null), Q(() => X(i, "title", a.name ?? "")), s;
        })()
      })];
    }
  });
...
C1(["click"]);
var rC = /* @__PURE__ */ d('<i class="icon-close klinecharts-pro-load-icon">'), aC = /* @__PURE__ */ d("<div class=klinecharts-pro-content><div class=klinecharts-pro-widget>");
function X1(e, t, n, r) {
  return t === "VOL" && (r = {
    gap: {
      bottom: 2
...
const iC = (e) => {
  let t, n = null, r, a = !1, s = !0;
  const [o, i] = $(e.theme), [l, C] = $(e.styles), [f, c] = $(e.locale), [_, b] = $(e.symbol), [P, S] = $(e.period), [L, k] = $(e.pinnedTimeframes ?? []), [T, D] = $(!1), [x, W] = $([...e.mainIndicators]), [a1, q] = $({}), [g1, w] = $(!1), [M, Y] = $({
    key: e.timezone,
    text: D9(e.timezone, e.locale)
  }), [R, e1] = $(!1), [A1, w1] = $(), [v1, A] = $(""), [K, i1] = $(e.drawingBarVisible), [I, z] = $(!1), [t1, l1] = $(!1), [$1, n1] = $({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  ...
  const s1 = () => {
    ...
    switch (g.timespan) {
      case "second": {
        h = h - h % 1e3, B = h - p * g.multiplier * 1e3;
        break;
      }
      case "minute": {
        h = h - h % (60 * 1e3), B = h - p * g.multiplier * 60 * 1e3;
        break;
      }
      case "hour": {
        h = h - h % (60 * 60 * 1e3), B = h - p * g.multiplier * 60 * 60 * 1e3;
        break;
      }
      case "day": {
        h = h - h % (60 * 60 * 1e3), B = h - p * g.multiplier * 24 * 60 * 60 * 1e3;
        break;
      }
      case "week": {
        const H = new Date(h).getDay(), r1 = H === 0 ? 6 : H - 1;
        h = h - r1 * 60 * 60 * 24;
        const _1 = new Date(h);
        h = (/* @__PURE__ */ new Date(`${_1.getFullYear()}-${_1.getMonth() + 1}-${_1.getDate()}`)).getTime(), B = p * g.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
        const E = new Date(h), H = E.getFullYear(), r1 = E.getMonth() + 1;
        h = (/* @__PURE__ */ new Date(`${H}-${r1}-01`)).getTime(), B = p * g.multiplier * 30 * 24 * 60 * 60 * 1e3;
        const _1 = new Date(B);
        B = (/* @__PURE__ */ new Date(`${_1.getFullYear()}-${_1.getMonth() + 1}-01`)).getTime();
        break;
      }
      case "year": {
        const H = new Date(h).getFullYear();
        h = (/* @__PURE__ */ new Date(`${H}-01-01`)).getTime(), B = p * g.multiplier * 365 * 24 * 60 * 60 * 1e3;
        const r1 = new Date(B);
        B = (/* @__PURE__ */ new Date(`${r1.getFullYear()}-01-01`)).getTime();
        break;
      }
    }
    return [B, h];
  ...
  return E9(() => {
    if (window.addEventListener("resize", s1), n = L5(t, {
      customApi: {
        formatDate: (p, h, B, E) => {
          switch (P().timespan) {
            case "second":
              return E === F1.XAxis ? F.formatDate(p, h, "HH:mm:ss") : F.formatDate(p, h, "YYYY-MM-DD HH:mm:ss");
            case "minute":
              return E === F1.XAxis ? F.formatDate(p, h, "HH:mm") : F.formatDate(p, h, "YYYY-MM-DD HH:mm");
            case "hour":
              return E === F1.XAxis ? F.formatDate(p, h, "MM-DD HH:mm") : F.formatDate(p, h, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return F.formatDate(p, h, "YYYY-MM-DD");
            case "month":
              return E === F1.XAxis ? F.formatDate(p, h, "YYYY-MM") : F.formatDate(p, h, "YYYY-MM-DD");
            case "year":
              return E === F1.XAxis ? F.formatDate(p, h, "YYYY") : F.formatDate(p, h, "YYYY-MM-DD");
          }
          return F.formatDate(p, h, "YYYY-MM-DD HH:mm");
        }
      }
    }), n) {
      const p = n.getDom("candle_pane", U0.Main);
      if (p) {
        let B = document.createElement("div");
        if (B.className = "klinecharts-pro-watermark", F.isString(e.watermark)) {
      ...
      const h = n.getDom("candle_pane", U0.YAxis);
      r = document.createElement("span"), r.className = "klinecharts-pro-price-unit", h == null || h.appendChild(r);
    }
    x().forEach((p) => {
      X1(n, p, !0, {
        id: "candle_pane"
    ...
    const v = (p) => {
      if (a || !s || p == null)
        return;
      a = !0, (async () => {
        const B = P(), [E] = V(B, p, 1), [H] = V(B, E, 500), r1 = await e.datafeed.getHistoryKLineData(_(), B, H, E);
        s = r1.length > 0, n == null || n.applyMoreData(r1, s), a = !1;
      })();
    };
    n == null || n.loadMore((p) => {
      v(p);
    }), n == null || n.subscribeAction(Y0.OnVisibleRangeChange, (p) => {
      var E;
      const h = p;
      if (!h || typeof h.from != "number" || typeof h.to != "number")
        return;
      const B = Math.max(1, h.to - h.from);
      if (h.from <= Math.floor(B * 0.6)) {
        const H = (n == null ? void 0 : n.getDataList()) ?? [];
        v(((E = H[h.from]) == null ? void 0 : E.timestamp) ?? null);
      }
    }), n == null || n.subscribeAction(Y0.OnTooltipIconClick, (p) => {
      if (p.indicatorName)
        switch (p.iconId) {
          case "visible": {
          ...
          case "setting": {
            const h = n == null ? void 0 : n.getIndicatorByPaneId(p.paneId, p.indicatorName);
            n1({
              visible: !0,
              indicatorName: p.indicatorName,
              paneId: p.paneId,
              calcParams: h.calcParams
            });
            break;
          }
          case "close":
            if (p.paneId === "candle_pane") {
              const h = [...x()];
              n == null || n.removeIndicator("candle_pane", p.indicatorName), h.splice(h.indexOf(p.indicatorName), 1), W(h);
            } else {
              const h = {
                ...a1()
              };
              n == null || n.removeIndicator(p.paneId, p.indicatorName), delete h[p.indicatorName], q(h);
            }
        }
    });
  }), u0(() => {
    window.removeEventListener("resize", s1), $5(t);
  }), d1(() => {
    const g = _();
    g != null && g.priceCurrency ? (r.innerHTML = g == null ? void 0 : g.priceCurrency.toLocaleUpperCase(), r.style.display = "flex") : r.style.display = "none", n == null || n.setPriceVolumePrecision((g == null ? void 0 : g.pricePrecision) ?? 2, (g == null ? void 0 : g.volumePrecision) ?? 0);
  }), d1((g) => {
    const v = _(), p = P();
    return a ? g : (g && e.datafeed.unsubscribe(g.symbol, g.period), a = !0, s = !0, l1(!0), (async () => {
      const [B, E] = V(p, (/* @__PURE__ */ new Date()).getTime(), 500), H = await e.datafeed.getHistoryKLineData(v, p, B, E);
      n == null || n.applyNewData(H, H.length > 0), e.datafeed.subscribe(v, p, (p5) => {
        n == null || n.updateData(p5);
      }), a = !1, l1(!1);
      const r1 = _(), _1 = P();
      (r1.ticker !== v.ticker || _1.text !== p.text) && b({
        ...r1
      });
    })(), {
      symbol: v,
    ...
    n == null || n.setTimezone(M().key);
  }), d1(() => {
    l() && (n == null || n.setStyles(l()), w1(Or(n.getStyles())));
  }), [rC(), y(U, {
    get when() {
      return I();
    },
    get children() {
      return y(nC, {
        ...
        onSymbolSelected: (g) => {
          var v;
          b(g), (v = e.onSymbolChange) == null || v.call(e, g);
        },
        onClose: () => {
          z(!1);
        }
    ...
    get children() {
      return y(Zu, {
        ...
        onMainIndicatorChange: (g) => {
          const v = [...x()];
          g.added ? (X1(n, g.name, !0, {
            id: "candle_pane"
          }), v.push(g.name)) : (n == null || n.removeIndicator("candle_pane", g.name), v.splice(v.indexOf(g.name), 1)), W(v);
        },
        onSubIndicatorChange: (g) => {
          const v = {
            ...a1()
          };
          if (g.added) {
            ...
            g.paneId && (n == null || n.removeIndicator(g.paneId, g.name), delete v[g.name]);
          q(v);
        }
      });
    }
    ...
    get children() {
      return y(Yu, {
        ...
        onRestoreDefault: (g) => {
          ...
          g.forEach((p) => {
            const h = p.key;
            k0(v, h, F.formatValue(A1(), h));
          }), n == null || n.setStyles(v);
        }
      });
    }
  }), y(U, {
    ...
    get pinnedTimeframes() {
      return L();
    },
    onPinChange: (g) => {
      var v;
      k(g), (v = e.onPinChange) == null || v.call(e, g);
    },
    onMenuClick: async () => {
      try {
        await X5(() => i1(!K())), n == null || n.resize();
      } catch {
      }
    },
    onSymbolClick: () => {
    ...
    onPeriodChange: (g) => {
      var v;
      S(g), (v = e.onPeriodChange) == null || v.call(e, g);
    },
    onIndicatorClick: () => {
      D((g) => !g);
    },
    ...
    onScreenshotClick: () => {
      if (n) {
        const g = n.getConvertPictureUrl(!0, "jpeg", e.theme === "dark" ? "#151517" : "#ffffff");
        A(g);
      }
    }
  }), (() => {
    var g = aC(), v = g.firstChild;
    m(g, y(U, {
      get when() {
        return t1();
      },
...
class fC {
  constructor(t) {
    ...
    this._container.classList.add("klinecharts-pro"), this._container.setAttribute("data-theme", t.theme ?? "light"), oe(() => {
      const n = this;
      return y(iC, {
        ref: (r) => {
          n._chartApi = r;
        ...
        get onSymbolChange() {
          return t.onSymbolChange;
        },
        get onPeriodChange() {
          return t.onPeriodChange;
        },
        get pinnedTimeframes() {
          return t.pinnedTimeframes;
        },
        get onPinChange() {
          return t.onPinChange;
        },
        get datafeed() {
          return t.datafeed;
        }
  ...
  getChart() {
    var t;
    return ((t = this._chartApi) == null ? void 0 : t.getChart()) ?? null;
  }
}
Z5.forEach((e) => {
  b5(e);
